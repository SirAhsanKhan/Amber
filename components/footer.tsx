      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-3 mb-6">
              ...
              />
              <div>
                <h3 className="text-xl font-bold">AMBER EDUCATION</h3>
                <p className="text-sm opacity-90">CONSULTANTS</p>
              </div>
            </div>
            <p className="text-secondary-foreground/80 mb-6 leading-relaxed max-w-md">
              Crafting Gems of Tomorrow. We are dedicated to making changes in the world by collaborating through 150+
              countries, helping students achieve their educational dreams abroad.
            </p>
        ...
        <div className="border-t border-secondary-foreground/20 mt-12 pt-8">
          <div className="flex flex-col md:flex-row items-center justify-between">
            <div className="mb-4 md:mb-0">
              ...
              <p className="text-secondary-foreground/80">Get the latest updates on study abroad opportunities</p>
            </div>
            <div className="flex w-full md:w-auto">
              <Input
                type="email"
                placeholder="Enter your email"
                className="rounded-r-none bg-input border-input text-foreground"
              />
        ...
        <div className="border-t border-secondary-foreground/20 mt-8 pt-8 text-center">
          <p className="text-secondary-foreground/60">
            © 2024 Amber Education Consultants. All rights reserved. | Privacy Policy | Terms of Service
          </p>
        </div>
      </div>
    </footer>
